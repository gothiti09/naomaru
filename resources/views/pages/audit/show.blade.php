...
@section('content')
    ...
    <x-molecules.icon-description title="監査スコア">
        ...
        <x-slot name="description">
            <p>監査スコア<span class="text-3xl text-primary-500">{{ $audit->point_avg }}</span>％（スコア合計<span
                    class="text-xl text-primary-500">{{ $audit->point_full }}</span>ポイント中、<span
                    class="text-xl text-primary-500">{{ $audit->point_sum }}</span>ポイント）　</p>
